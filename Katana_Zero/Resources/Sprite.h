...
public:
	...
	void RenderStretchedSprite(HDC hdc, Vector2 pos, bool isFlipped);
	...
	bool IsSpriteEnd()
	{
		return (iCurrentFrame == iFrameCount);
	}
	...
	void SetCurrentFrame(int32 currentFrame) { iCurrentFrame = currentFrame; }
	void IncreaseCurrentFrame() { ++iCurrentFrame; }
};

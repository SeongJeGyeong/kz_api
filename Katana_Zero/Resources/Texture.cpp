...
//}
//
//void Texture::RenderStretchedSprite(HDC hdc, Vector2 pos, int32 frameCount, int32 currentFrame, int32 frameSizeX, int32 frameSizeY, int32 originX, int32 originY, int32 magnification, bool isFlipped, Vector2 offset)
//{
//	BLENDFUNCTION op;
//	op.BlendOp = AC_SRC_OVER;
//	op.BlendFlags = 0;
...
//	op.AlphaFormat = AC_SRC_ALPHA;
//
//	int32 stretchedWidth = frameSizeX * magnification;
//	int32 stretchedHeight = frameSizeY * magnification;
//
//	if (isFlipped)
//	{
//		AlphaBlend(hdc,
//			(int32)pos.x - (stretchedWidth * 0.5f) - offset.x,
//			(int32)pos.y - (stretchedHeight * 0.5f) + offset.y,
//			stretchedWidth,
//			stretchedHeight,
//			_flippedTextureHdc,
//			(frameCount - currentFrame - 1) * frameSizeX,
//			0,
//			frameSizeX,
//			frameSizeY,
//			op);
...
//void Texture::RenderStretchedSprite(HDC hdc, int32 startPosX, int32 startPosY, int32 endPosX, int32 endPosY, int32 srcStartX, int32 srcStartY, int32 srcEndX, int32 srcEndY, bool isFlipped)
//{
//	BLENDFUNCTION op;
//	op.BlendOp = AC_SRC_OVER;
//	op.BlendFlags = 0;

// Katana_Zero.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
#include "pch.h"
#include "framework.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    // 1초는 1000ms
    // 초당 120프레임 제한
    const float targetFrameTime = 1000.f / 120.f;
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   gHwnd = CreateWindowW(
       ...
       mainWindowRect.right - mainWindowRect.left, mainWindowRect.bottom - mainWindowRect.top, nullptr, nullptr, hInstance, nullptr);
   ...
   gSubHwnd = CreateWindowW(
       ...
       WS_OVERLAPPEDWINDOW,
       CW_USEDEFAULT, 0, 
       subWindowRect.right - subWindowRect.left, subWindowRect.bottom - subWindowRect.top,
       //TileMapWidth * TILE_SIZE + 50, TileMapHeight * TILE_SIZE + 70,
